...
export default function Home() {
  return (
    <div className="overflow-y-scroll no-scrollbar overflow-hidden md:overflow-hidden">
      <main className="bg-gradient-to-br from-slate-100 to-white min-h-screen">
        <Hero />
        <div className=" text-4xl font-bold bg-gradient-to-r from-red-600 via-black to-black bg-clip-text text-transparent text-center w-fit mx-auto mt-1">
          ...
          <p className="text-sm mt-4 max-w-xl">
            ...
            som fascinerar och engagerar. Min entusiasm för frontend
        ...
        <AnimationProvider>
          ...
          >
            ...
            <p className="max-w-4xl  text-sm text-slate-500  text-center leading-relaxed">
              ...
              <br />
              Jag är flexibel och lär mig snabbt nya verktyg och tekniker för
              att möta just era behov.
              <br />
              Hovra gärna över varje skill för att se en kort beskrivning.
              <br />
              Prova även knapparna — min personliga avatar är en lekfull
              spegling av mig själv.
            </p>
        ...
        >
          ...
          <div className="py-2 flex  gap-20 flex-col md:flex-row items-start">
            ...
            <p className="max-w-3xl xl:text-wm md:text-xl bg-gradient-to-r from-red-600 via-black to-black bg-clip-text text-transparent text-left  order-last text-md">
              ...
              affärsmodell.
              <br />
              Jag erbjuder expertis inom Learning Management Systems (LMS) för
              att säkerställa effektiv onboarding och kontinuerlig utbildning –
              både internt och för dina kunder. Genom digitala plattformar
              skapar vi strukturerad, engagerande och mätbar
              kompetensutveckling.
              <br />
              ...
              din data och fatta mer insiktsdrivna beslut. Vi gör din
              information sökbar, skalbar och användbar – i realtid.
              <br />
              Jag utvecklar även anpassade chatbotar och AI-agenter som
              förbättrar kundupplevelsen, automatiserar support och skapar
              starkare relationer genom varje interaktion. Dessa agenter
              integreras sömlöst med dina system och lär sig kontinuerligt för
              att ge ännu bättre svar.
            </p>
          </div>
        </section>
